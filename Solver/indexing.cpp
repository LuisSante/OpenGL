...
int Indexing::orientation_to_index(std::vector<int> const& arr, int orientation_cnt)
{
    int n = arr.size();
    int index = 0;
    for (int i = 0; i < n; i++)
...
void Indexing::index_to_orientation(int index, std::vector<int>& arr, int orientation_cnt)
{
    int n = arr.size();
    for (int i = n - 1; i >= 0; i--)
    {
